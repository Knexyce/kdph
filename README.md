...
* HMAC ensures tamper-proof integrity.
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/integrity-HMAC--SHA256-green" />
...
2. **AES-256-GCM** – Encrypts files in **16 MB chunks**, ensuring confidentiality and integrity.
3. **HMAC-SHA256** – Applied over the final ciphertext to verify integrity and detect tampering.
